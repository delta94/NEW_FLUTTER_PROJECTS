...
class Result {
  ResultInfo resultInfoD = new ResultInfo(Types.D, 'Dominance', 'images/dominance.png',
  [
  ...
  ResultInfo resultInfoI = new ResultInfo(Types.I, 'Influence', 'images/influence.png', [
  ...
  ResultInfo resultInfoS = new ResultInfo(Types.S, 'Steadiness', 'images/steadiness.png', [
  ...
  ResultInfo resultInfoC = new ResultInfo(Types.C, 'Caution', 'images/caution.png', [
  ...
  getResultInfoByType(Types type) {
    switch (type) {
      case Types.D:
        return resultInfoD;
        break;
