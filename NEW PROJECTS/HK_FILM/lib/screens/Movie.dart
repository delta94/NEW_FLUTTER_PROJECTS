...
import 'package:firebase_admob_example/screens/PlayerBuider.dart';
import 'package:firebase_admob_example/youtube_player/youtube_player_controller.dart';
import 'package:firebase_admob_example/youtube_player/youtube_player_flutter.dart';
      ...
      body: new Stack(
        children: <Widget>[
          ...
          new Container(
            ...
            children: <Widget>[
              Container(
                child: PlayerBuider.buildPlayer(controller, _showControls),
              ),
