...
class Loop_U extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Chủng LU', style: TextStyle(color: Colors.yellowAccent),),
                ...
                children: <Widget>[
                  Center(
                    child: Column(children: <Widget>[
                      Divider(),
                      Text("Chủng nước LU", style: TextStyle(color: Colors.cyanAccent, fontWeight: FontWeight.bold, fontSize: 25),),
                      Divider(),
                      Column(children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Column(children: <Widget>[
                              Image.asset("images/UL_right.png", height: 200, width: 150),
                              Text('Tay Phải', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),)
                            ],),
                          ],
                        ),
                        Image.asset("images/ul_draw.JPG", height: 200, width: 150),
                      ],),
                          ...
                          child: PageView(
                            ...
                            children: <Widget>[
                              CommonUI.textCard('Đặc tính:', -1, 1,
                                Column(
                                  children: <Widget>[
                                    CommonUI.bulletText(' Xác suất xuất hiện: 55%. Hình dạng như dòng nước chảy xuôi về phía ngón tay út. Hay còn được gọi là chủng vân tay NƯỚC.'),
                                    Divider(),
                              ...
                              CommonUI.textCard('Giao tiếp với với chủng LU:', 3, -1,
                                Column(
                                  children: <Widget>[
