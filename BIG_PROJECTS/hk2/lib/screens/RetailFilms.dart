...
class RetailFilms extends StatefulWidget {
  RetailFilms({Key key}) : super(key: key);
  RetailFilmsState createState() => RetailFilmsState();
}

class RetailFilmsState extends State<RetailFilms> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: AppBar(
        title: Text('Phim Lẻ Xưa Hay', style: TextStyle(color: Colors.yellow),),
