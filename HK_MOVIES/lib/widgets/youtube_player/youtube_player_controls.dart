...
class YoutubeControl extends StatefulWidget {
  final YoutubePlayerController controller;
  final ValueNotifier<bool> showControls;
  final Widget bufferIndicator;

  YoutubeControl(this.controller, this.showControls, this.bufferIndicator);

  @override
  _YoutubeControlState createState() => _YoutubeControlState();
}

class _YoutubeControlState extends State<YoutubeControl>
      ...
      child:  Visibility(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Text(
              CommonFunctions.durationFormatter(_currentPosition),
              style: TextStyle(
                color: Colors.white,
                fontSize: 12.0,
              ),
            ...
            Text(
              "- ${CommonFunctions.durationFormatter(_remainingDuration)}",
              style: TextStyle(
                color: Colors.white,
                fontSize: 12.0,
              ),
            ...
            onHorizontalDragUpdate: (details) {
              ...
              setState(() {
                seekDuration = (delta < 0 ? "- " : "+ ") +
                    CommonFunctions.durationFormatter(
                        (delta < 0 ? -1 : 1) * (delta * 1000).round());
                if (seekToPosition < 0) seekToPosition = 0;
                seekPosition = CommonFunctions.durationFormatter(seekToPosition);
              });
            },
