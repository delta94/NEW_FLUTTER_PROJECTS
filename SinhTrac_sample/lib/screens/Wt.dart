          ...
          AdBannerTemplate(
            child: new Container(
              ...
              Row(
                ...
                children: <Widget>[
                  Image.asset("images/WT.png", width: deviceWidth * 0.2),
                          ...
                          child: ListView(
                            ...
                            Column(children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    child: Text('- Tinh thần trách nhiệm cao.',
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 15)),
                                  ),
                                ],
                            ...
                            Column(children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    child: Text(
                                        '- Học thêm kỹ năng thiết lập và quản lý mục tiêu, có thể đặt mục tiêu theo nguyên tắc SMART sẽ giúp họ phát huy lợi thế của bản thân và dễ dàng đạt được sự thành công trong công việc.',
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 15)),
                                  ),
                                ],
                              ...
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    child: Text(
                                        '- Đối với trẻ em: Khuyến khích và tạo động lực cho trẻ mỗi ngày để trẻ có thể học hỏi từ thất bại, nhận ra thất bại, mạnh mẽ và dũng cảm hơn khi đối mặt với thất bại.',
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 15)),
                                  ),
                                ],
                            ...
                            Column(children: <Widget>[
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    child: Text(
                                        '- Đối với người sở hữu mẫu vân tay WT, họ phù hợp với phong cách giao tiếp dân chủ, mang tính xây dựng nhiều hơn là chiều hướng chiếm hữu hoặc áp đảo.',
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 15)),
                                  ),
                                ],
                              ...
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    child: Text(
                                        '- Nên nhắc nhở ít, không nên nhắc nhiều, nếu nhắc nhiều dễ cáu.',
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 15)),
                                  ),
                                ],
