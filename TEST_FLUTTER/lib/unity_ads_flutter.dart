...
class UnityAdsFlutter {
  static const MethodChannel _channel =
      const MethodChannel('eu.epnw.unity_ads_flutter');
  ...
  static Future<PlacementState> getDefaultPlacementState() async {
    int placementState =
        await _channel.invokeMethod('getDefaultPlacementState');
    return PlacementState.values[placementState];
  }

  static Future<PlacementState> getPlacementState(String placementId) async {
    int placementState = await _channel
        .invokeMethod('getPlacementState', {'placementId': placementId});
    return PlacementState.values[placementState];
  }
  ...
  static Future<Null> initialize(
    ...
    await _channel
        .invokeMethod('initialize', {'gameId': gameId, 'testMode': testMode});
  }
  ...
  static Future<bool> isReady(String placementId) async {
    bool ready =
        await _channel.invokeMethod('isReady', {'placementId': placementId});
    return ready;
  }
