...
public class AlertDialogLayout extends C0534Q {
    ...
    /* renamed from: b */
    private void m2400b(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m2401c(View view) {
        int h = C0156v.m567h(view);
        if (h > 0) {
            return h;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2401c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: e */
    private void m2402e(int i, int i2) {
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0535a aVar = (C0535a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: f */
    private boolean m2403f(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0168f.topPanel) {
                    view = childAt;
                } else if (id == C0168f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0168f.contentPanel && id != C0168f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            android.support.v7.widget.Q$a r15 = (android.support.p030v7.widget.C0534Q.C0535a) r15
            int r2 = r15.f2012b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = p000a.p005b.p009c.p018g.C0156v.m565g(r17)
            int r2 = p000a.p005b.p009c.p018g.C0139f.m475a(r2, r3)
            r2 = r2 & 7
            r3 = 1
        ...
        L_0x00bd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p030v7.widget.AlertDialogLayout.onLayout(boolean, int, int, int, int):void");
    }
