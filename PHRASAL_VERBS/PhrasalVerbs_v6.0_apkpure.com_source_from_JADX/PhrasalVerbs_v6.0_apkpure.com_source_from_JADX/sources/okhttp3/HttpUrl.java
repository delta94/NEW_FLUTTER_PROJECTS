...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private void pop() {
            ...
            boolean isEmpty = ((String) list.remove(list.size() - 1)).isEmpty();
            String str = HttpUrl.FRAGMENT_ENCODE_SET;
        ...
        public Builder encodedFragment(String str) {
            String str2;
            if (str != null) {
                str2 = HttpUrl.canonicalize(str, HttpUrl.FRAGMENT_ENCODE_SET, true, false, false, false);
            } else {
                str2 = null;
            }
        ...
        public Builder fragment(String str) {
            String str2;
            if (str != null) {
                str2 = HttpUrl.canonicalize(str, HttpUrl.FRAGMENT_ENCODE_SET, false, false, false, false);
            } else {
                str2 = null;
            }
            this.encodedFragment = str2;
                    ...
                    if (charAt == 65535 || charAt == c2 || charAt == '/' || charAt == '\\' || charAt == c) {
                        ...
                        if (charAt == '@') {
                            ...
                            if (!z) {
                                ...
                                if (i5 != i) {
                                    this.encodedPassword = HttpUrl.canonicalize(str, i5 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                                    z = true;
                                }
                                z2 = true;
                            } else {
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i4 < i3) {
            ...
            int i5 = i;
            gVar.mo7101a(str, i, i4);
            canonicalize(gVar, str, i4, i2, str2, z, z2, z3, z4, charset);
            return gVar.mo7142p();
        }
        int i6 = i;
    ...
    static void canonicalize(C2011g gVar, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        C2011g gVar2 = null;
        while (i < i2) {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    if (charset == null || charset.equals(Util.UTF_8)) {
                        gVar2.mo7115c(codePointAt);
                    } else {
                        gVar2.mo7102a(str, i, Character.charCount(codePointAt) + i, charset);
                    }
                    while (!gVar2.mo7119d()) {
    ...
    static String percentDecode(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            if (charAt == '%' || (charAt == '+' && z)) {
                C2011g gVar = new C2011g();
                gVar.mo7101a(str, i, i3);
                percentDecode(gVar, str, i3, i2, z);
                return gVar.mo7142p();
            }
        }
        return str.substring(i, i2);
    ...
    static void percentDecode(C2011g gVar, String str, int i, int i2, boolean z) {
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37) {
                int i3 = i + 2;
    ...
    public String redact() {
        ...
        String str = FRAGMENT_ENCODE_SET;
