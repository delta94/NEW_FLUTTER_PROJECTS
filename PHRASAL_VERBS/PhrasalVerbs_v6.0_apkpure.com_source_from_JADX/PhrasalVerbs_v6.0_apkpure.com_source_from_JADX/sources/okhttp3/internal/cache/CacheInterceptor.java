...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) {
        ...
        C1999C body = cacheRequest.body();
        if (body == null) {
            return response;
        }
        final C2014i source = response.body().source();
        final C2013h a = C2025t.m7755a(body);
        C20551 r2 = new C2000D() {
            ...
            public long read(C2011g gVar, long j) {
                try {
                    ...
                    gVar.mo7098a(a.mo7097a(), gVar.size() - read, read);
                    a.mo7121e();
                    return read;
                } catch (IOException e) {
                    if (!this.cacheRequestClosed) {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header("Content-Type"), response.body().contentLength(), C2025t.m7756a((C2000D) r2))).build();
    }
