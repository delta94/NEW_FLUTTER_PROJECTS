...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            ...
            r5.this$0.journalWriter = p133e.C2025t.m7755a(p133e.C2025t.m7748a());
         */
        ...
        public void run() {
            ...
            L_0x0033:
                ...
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                e.C r2 = p133e.C2025t.m7748a()     // Catch:{ all -> 0x0045 }
                e.h r2 = p133e.C2025t.m7755a(r2)     // Catch:{ all -> 0x0045 }
            ...
            L_0x0045:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.C20561.run():void");
        }
    };
    boolean closed;
    ...
    public final class Editor {
        ...
        public C1999C newSink(int i) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    throw new IllegalStateException();
                } else if (this.entry.currentEditor != this) {
                    C1999C a = C2025t.m7748a();
                    return a;
                } else {
                    ...
                    try {
                        C20591 r1 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public p133e.C2000D newSource(int r5) {
            /*
                r4 = this;
                okhttp3.internal.cache.DiskLruCache r0 = okhttp3.internal.cache.DiskLruCache.this
                monitor-enter(r0)
            ...
            L_0x0015:
                ...
                e.D r5 = r1.source(r5)     // Catch:{ FileNotFoundException -> 0x0025 }
            ...
            L_0x002f:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.Editor.newSource(int):e.D");
        }
    }
    ...
    private final class Entry {
        ...
        public Snapshot snapshot() {
            if (Thread.holdsLock(DiskLruCache.this)) {
                C2000D[] dArr = new C2000D[DiskLruCache.this.valueCount];
                long[] jArr = (long[]) this.lengths.clone();
                int i = 0;
                int i2 = 0;
                while (i2 < DiskLruCache.this.valueCount) {
                    try {
                        dArr[i2] = DiskLruCache.this.fileSystem.source(this.cleanFiles[i2]);
                        i2++;
                    } catch (FileNotFoundException unused) {
                        while (i < DiskLruCache.this.valueCount && dArr[i] != null) {
                            Util.closeQuietly((Closeable) dArr[i]);
                            i++;
                        }
                        try {
                ...
                Snapshot snapshot = new Snapshot(this.key, this.sequenceNumber, dArr, jArr);
                return snapshot;
            }
        ...
        /* access modifiers changed from: 0000 */
        public void writeLengths(C2013h hVar) {
            for (long g : this.lengths) {
                hVar.writeByte(32).mo7126g(g);
            }
        }
    }
    ...
    public final class Snapshot implements Closeable {
        ...
        private final C2000D[] sources;

        Snapshot(String str, long j, C2000D[] dArr, long[] jArr) {
            this.key = str;
        ...
        public void close() {
            for (C2000D closeQuietly : this.sources) {
    ...
    private C2013h newJournalWriter() {
        return C2025t.m7755a((C1999C) new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
            static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x006a, code lost:
        if (r1.mo7119d() == false) goto L_0x006c;
     */
    ...
    private void readJournal() {
        /*
            ...
            e.D r1 = r1.source(r2)
            e.i r1 = p133e.C2025t.m7756a(r1)
            java.lang.String r2 = r1.mo7127g()     // Catch:{ all -> 0x00a8 }
            java.lang.String r3 = r1.mo7127g()     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = r1.mo7127g()     // Catch:{ all -> 0x00a8 }
            java.lang.String r5 = r1.mo7127g()     // Catch:{ all -> 0x00a8 }
            java.lang.String r6 = r1.mo7127g()     // Catch:{ all -> 0x00a8 }
            ...
            r0 = 0
        L_0x0053:
            java.lang.String r2 = r1.mo7127g()     // Catch:{ EOFException -> 0x005d }
        ...
        L_0x005d:
            ...
            boolean r0 = r1.mo7119d()     // Catch:{ all -> 0x00a8 }
            if (r0 != 0) goto L_0x0070
            r9.rebuildJournal()     // Catch:{ all -> 0x00a8 }
            goto L_0x0076
        L_0x0070:
            e.h r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a8 }
    ...
    public synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r10, boolean r11) {
        ...
        L_0x007f:
            ...
            e.h r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r1 = "CLEAN"
            e.h r10 = r10.mo7100a(r1)     // Catch:{ all -> 0x00fb }
            r10.writeByte(r3)     // Catch:{ all -> 0x00fb }
            e.h r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r1 = r0.key     // Catch:{ all -> 0x00fb }
            r10.mo7100a(r1)     // Catch:{ all -> 0x00fb }
            e.h r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
        ...
        L_0x00bb:
            ...
            e.h r10 = r10.mo7100a(r11)     // Catch:{ all -> 0x00fb }
            r10.writeByte(r3)     // Catch:{ all -> 0x00fb }
            e.h r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fb }
            r10.mo7100a(r11)     // Catch:{ all -> 0x00fb }
            e.h r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            r10.writeByte(r2)     // Catch:{ all -> 0x00fb }
        L_0x00d9:
            e.h r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) {
        ...
        L_0x002b:
            ...
            goto L_0x006b
        L_0x0034:
            e.h r7 = r5.journalWriter     // Catch:{ all -> 0x0074 }
            java.lang.String r8 = "DIRTY"
            e.h r7 = r7.mo7100a(r8)     // Catch:{ all -> 0x0074 }
            r8 = 32
            e.h r7 = r7.writeByte(r8)     // Catch:{ all -> 0x0074 }
            e.h r7 = r7.mo7100a(r6)     // Catch:{ all -> 0x0074 }
            r8 = 10
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) {
        ...
        L_0x0022:
            ...
            e.h r1 = r3.journalWriter     // Catch:{ all -> 0x0050 }
            java.lang.String r2 = "READ"
            e.h r1 = r1.mo7100a(r2)     // Catch:{ all -> 0x0050 }
            r2 = 32
            e.h r1 = r1.writeByte(r2)     // Catch:{ all -> 0x0050 }
            e.h r4 = r1.mo7100a(r4)     // Catch:{ all -> 0x0050 }
            r1 = 10
    ...
    public synchronized void rebuildJournal() {
        ...
        C2013h a = C2025t.m7755a(this.fileSystem.sink(this.journalFileTmp));
        try {
            a.mo7100a(MAGIC).writeByte(10);
            a.mo7100a(VERSION_1).writeByte(10);
            a.mo7126g((long) this.appVersion).writeByte(10);
            a.mo7126g((long) this.valueCount).writeByte(10);
            a.writeByte(10);
            for (Entry entry : this.lruEntries.values()) {
                if (entry.currentEditor != null) {
                    a.mo7100a(DIRTY).writeByte(32);
                    a.mo7100a(entry.key);
                } else {
                    a.mo7100a(CLEAN).writeByte(32);
                    a.mo7100a(entry.key);
    ...
    public boolean removeEntry(Entry entry) {
        ...
        this.journalWriter.mo7100a(REMOVE).writeByte(32).mo7100a(entry.key).writeByte(10);
