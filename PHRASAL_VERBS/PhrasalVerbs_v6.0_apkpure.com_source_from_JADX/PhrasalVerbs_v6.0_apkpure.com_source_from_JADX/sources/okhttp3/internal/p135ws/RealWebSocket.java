...
import okhttp3.internal.p135ws.WebSocketReader.FrameCallback;
import p133e.C2013h;
import p133e.C2014i;
import p133e.C2015j;
...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    private final ArrayDeque<C2015j> pongQueue = new ArrayDeque<>();
    ...
    static final class Close {
        ...
        Close(int i, C2015j jVar, long j) {
            this.code = i;
            this.reason = jVar;
    ...
    public static abstract class Streams implements Closeable {
        ...
        public final C2013h sink;
        public final C2014i source;

        public Streams(boolean z, C2014i iVar, C2013h hVar) {
            this.client = z;
            this.source = iVar;
            this.sink = hVar;
        }
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = C2015j.m7719a(bArr).mo7038a();
    ...
    private synchronized boolean send(p133e.C2015j r7, int r8) {
        /*
            r6 = this;
            monitor-enter(r6)
        ...
        L_0x000b:
            ...
            int r0 = r7.mo7048g()     // Catch:{ all -> 0x003e }
        ...
        L_0x0022:
            ...
            int r2 = r7.mo7048g()     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p135ws.RealWebSocket.send(e.j, int):boolean");
    }
        ...
        if (response.code() == 101) {
            ...
            if (str2.equalsIgnoreCase(header)) {
                ...
                if ("websocket".equalsIgnoreCase(header2)) {
                    ...
                    String a = C2015j.m7721c(sb.toString()).mo7045e().mo7038a();
                    if (!a.equals(header3)) {
    ...
    public synchronized boolean close(int i, String str, long j) {
        ...
        C2015j jVar = null;
        if (str != null) {
            jVar = C2015j.m7721c(str);
            if (((long) jVar.mo7048g()) > 123) {
                StringBuilder sb = new StringBuilder();
    ...
    public void failWebSocket(java.lang.Exception r4, okhttp3.Response r5) {
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p135ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }
    ...
    public void onReadMessage(C2015j jVar) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void onReadPing(p133e.C2015j r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            ...
            goto L_0x0022
        L_0x0012:
            java.util.ArrayDeque<e.j> r0 = r1.pongQueue     // Catch:{ all -> 0x0024 }
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p135ws.RealWebSocket.onReadPing(e.j):void");
    }

    public synchronized void onReadPong(C2015j jVar) {
        this.receivedPongCount++;
        this.awaitingPong = $assertionsDisabled;
    }

    /* access modifiers changed from: 0000 */
    public synchronized boolean pong(C2015j jVar) {
        boolean z;
        if (!this.failed) {
            if (!this.enqueuedClose || !this.messageAndCloseQueue.isEmpty()) {
    ...
    public boolean send(C2015j jVar) {
        if (jVar != null) {
            return send(jVar, 2);
        }
    ...
    public boolean send(String str) {
        if (str != null) {
            return send(C2015j.m7721c(str), 1);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0058, code lost:
        if ((r5 instanceof okhttp3.internal.p135ws.RealWebSocket.Message) == false) goto L_0x0086;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x005a, code lost:
        r1 = ((okhttp3.internal.p135ws.RealWebSocket.Message) r5).data;
        r0 = p133e.C2025t.m7755a(r0.newMessageSink(((okhttp3.internal.p135ws.RealWebSocket.Message) r5).formatOpcode, (long) r1.mo7048g()));
        r0.mo7099a(r1);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0088, code lost:
        if ((r5 instanceof okhttp3.internal.p135ws.RealWebSocket.Close) == false) goto L_0x009f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008a, code lost:
        r5 = (okhttp3.internal.p135ws.RealWebSocket.Close) r5;
    ...
    public boolean writeOneFrame() {
        ...
        L_0x0008:
            ...
            java.util.ArrayDeque<e.j> r2 = r11.pongQueue     // Catch:{ all -> 0x00aa }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x00aa }
            e.j r2 = (p133e.C2015j) r2     // Catch:{ all -> 0x00aa }
            r3 = -1
            r4 = 0
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p135ws.RealWebSocket.Close     // Catch:{ all -> 0x00aa }
        ...
        L_0x0031:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p135ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00aa }
        ...
        L_0x004f:
            ...
            goto L_0x009a
        L_0x0056:
            boolean r2 = r5 instanceof okhttp3.internal.p135ws.RealWebSocket.Message     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x0086
            r1 = r5
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p135ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x00a5 }
            e.j r1 = r1.data     // Catch:{ all -> 0x00a5 }
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p135ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00a5 }
            int r2 = r5.formatOpcode     // Catch:{ all -> 0x00a5 }
            int r3 = r1.mo7048g()     // Catch:{ all -> 0x00a5 }
            long r5 = (long) r3     // Catch:{ all -> 0x00a5 }
            e.C r0 = r0.newMessageSink(r2, r5)     // Catch:{ all -> 0x00a5 }
            e.h r0 = p133e.C2025t.m7755a(r0)     // Catch:{ all -> 0x00a5 }
            r0.mo7099a(r1)     // Catch:{ all -> 0x00a5 }
            r0.close()     // Catch:{ all -> 0x00a5 }
            monitor-enter(r11)     // Catch:{ all -> 0x00a5 }
            long r2 = r11.queueSize     // Catch:{ all -> 0x0083 }
            int r0 = r1.mo7048g()     // Catch:{ all -> 0x0083 }
        ...
        L_0x0086:
            boolean r2 = r5 instanceof okhttp3.internal.p135ws.RealWebSocket.Close     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x009f
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p135ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00a5 }
            int r2 = r5.code     // Catch:{ all -> 0x00a5 }
            e.j r3 = r5.reason     // Catch:{ all -> 0x00a5 }
        ...
        L_0x00aa:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p135ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        r0.writePing(p133e.C2015j.f5937b);
     */
    ...
    public void writePingFrame() {
        ...
        L_0x0012:
            ...
            return
        L_0x0048:
            e.j r1 = p133e.C2015j.f5937b     // Catch:{ IOException -> 0x004e }
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p135ws.RealWebSocket.writePingFrame():void");
    }
}
