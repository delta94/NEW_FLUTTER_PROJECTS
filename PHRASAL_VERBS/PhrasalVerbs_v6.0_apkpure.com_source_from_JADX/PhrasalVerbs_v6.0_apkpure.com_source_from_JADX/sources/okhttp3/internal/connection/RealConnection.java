...
import okhttp3.internal.p135ws.RealWebSocket.Streams;
...
public final class RealConnection extends Listener implements Connection {
    ...
    private void connectSocket(int i, int i2, Call call, EventListener eventListener) {
        ...
        try {
            ...
            try {
                this.source = C2025t.m7756a(C2025t.m7759b(this.rawSocket));
                this.sink = C2025t.m7755a(C2025t.m7752a(this.rawSocket));
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) {
        ...
        L_0x007f:
            ...
            e.D r8 = p133e.C2025t.m7759b(r8)     // Catch:{ AssertionError -> 0x0104, all -> 0x0102 }
            e.i r8 = p133e.C2025t.m7756a(r8)     // Catch:{ AssertionError -> 0x0104, all -> 0x0102 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0104, all -> 0x0102 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0104, all -> 0x0102 }
            e.C r8 = p133e.C2025t.m7752a(r8)     // Catch:{ AssertionError -> 0x0104, all -> 0x0102 }
            e.h r8 = p133e.C2025t.m7755a(r8)     // Catch:{ AssertionError -> 0x0104, all -> 0x0102 }
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) {
        ...
        while (true) {
            ...
            C2000D newFixedLengthSource = http1Codec.newFixedLengthSource(contentLength);
            ...
            } else if (this.source.mo7097a().mo7119d() && this.sink.mo7097a().mo7119d()) {
                return null;
            } else {
    ...
    private Request createTunnelRequest() {
        Request build = new Builder().url(this.route.address().url()).method("CONNECT", null).header("Host", Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header("User-Agent", Version.userAgent()).build();
    ...
    public Streams newWebSocketStreams(StreamAllocation streamAllocation) {
        ...
        C20601 r0 = new Streams(true, this.source, this.sink) {
            public void close() {
