...
final class Relay {
    ...
    static final C2015j PREFIX_CLEAN = C2015j.m7721c("OkHttp cache v1\n");
    static final C2015j PREFIX_DIRTY = C2015j.m7721c("OkHttp DIRTY :(\n");
    ...
    private final C2015j metadata;
    int sourceCount;
    C2000D upstream;
    final C2011g upstreamBuffer = new C2011g();
    long upstreamPos;
    Thread upstreamReader;

    class RelaySource implements C2000D {
        private FileOperator fileOperator = new FileOperator(Relay.this.file.getChannel());
        private long sourcePos;
        private final C2002F timeout = new C2002F();
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:74:?, code lost:
            ...
            r1.this$0.buffer.mo7098a(r22, r1.sourcePos - r5, r2);
            r1.sourcePos += r2;
         */
        ...
        public long read(p133e.C2011g r22, long r23) {
            /*
                r21 = this;
                r1 = r21
                r2 = r23
            ...
            L_0x0020:
                ...
                e.F r0 = r1.timeout     // Catch:{ all -> 0x0137 }
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
            ...
            L_0x0039:
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                e.g r5 = r5.buffer     // Catch:{ all -> 0x0137 }
            ...
            L_0x0094:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                e.g r13 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                r15 = 0
                r14 = r22
                r17 = r2
                r13.mo7098a(r14, r15, r17)     // Catch:{ all -> 0x0109 }
                ...
                long r16 = r7 + r11
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                e.g r0 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                e.g r18 = r0.clone()     // Catch:{ all -> 0x0109 }
                r19 = r5
                ...
                e.g r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                okhttp3.internal.cache2.Relay r8 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                e.g r8 = r8.buffer     // Catch:{ all -> 0x0106 }
            ...
            L_0x011b:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                e.g r9 = r0.buffer     // Catch:{ all -> 0x0137 }
                long r7 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r11 = r7 - r5
                r10 = r22
                r13 = r2
                r9.mo7098a(r10, r11, r13)     // Catch:{ all -> 0x0137 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r5 = r5 + r2
    ...
    private Relay(RandomAccessFile randomAccessFile, C2000D d, long j, C2015j jVar, long j2) {
        this.file = randomAccessFile;
        this.upstream = d;
        this.complete = d == null;
        this.upstreamPos = j;
        this.metadata = jVar;
        this.bufferMaxSize = j2;
    }

    public static Relay edit(File file2, C2000D d, C2015j jVar, long j) {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file2, "rw");
        Relay relay = new Relay(randomAccessFile, d, 0, jVar, j);
    ...
    public static Relay read(File file2) {
        ...
        if (gVar.mo7105a((long) PREFIX_CLEAN.mo7048g()).equals(PREFIX_CLEAN)) {
            long readLong = gVar.readLong();
            long readLong2 = gVar.readLong();
            C2011g gVar2 = new C2011g();
            fileOperator.read(readLong + FILE_HEADER_SIZE, gVar2, readLong2);
            Relay relay = new Relay(randomAccessFile, null, readLong, gVar2.mo7141o(), 0);
            return relay;
        }
        throw new IOException("unreadable cache file");
    }

    private void writeHeader(C2015j jVar, long j, long j2) {
        C2011g gVar = new C2011g();
        gVar.mo7099a(jVar);
        gVar.mo7137k(j);
        gVar.mo7137k(j2);
    ...
    private void writeMetadata(long j) {
        C2011g gVar = new C2011g();
        gVar.mo7099a(this.metadata);
        new FileOperator(this.file.getChannel()).write(FILE_HEADER_SIZE + j, gVar, (long) this.metadata.mo7048g());
    }
    ...
    public void commit(long j) {
        ...
        writeHeader(PREFIX_CLEAN, j, (long) this.metadata.mo7048g());
        this.file.getChannel().force(false);
        synchronized (this) {
            this.complete = true;
        }
    ...
    public C2015j metadata() {
        return this.metadata;
    }

    public C2000D newSource() {
        synchronized (this) {
            if (this.file == null) {
                return null;
            }
