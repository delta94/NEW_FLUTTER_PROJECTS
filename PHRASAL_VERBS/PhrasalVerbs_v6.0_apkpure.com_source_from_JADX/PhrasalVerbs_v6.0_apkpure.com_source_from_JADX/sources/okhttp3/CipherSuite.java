...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", C0172j.AppCompatTheme_toolbarNavigationButtonStyle);
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", C0172j.AppCompatTheme_textAppearanceSmallPopupMenu);
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", C0172j.AppCompatTheme_toolbarStyle);
    ...
    public static final CipherSuite TLS_DH_anon_WITH_AES_128_CBC_SHA256 = init("TLS_DH_anon_WITH_AES_128_CBC_SHA256", C0172j.AppCompatTheme_tooltipForegroundColor);
    ...
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA256 = init("TLS_DH_anon_WITH_AES_256_CBC_SHA256", C0172j.AppCompatTheme_tooltipFrameBackground);
