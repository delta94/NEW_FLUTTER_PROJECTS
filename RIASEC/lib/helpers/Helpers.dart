...
class Helpers {
  ...
  static setQuestionSentencesList(
      List<Question> questionSentencesList, int pageNum) {
    for (var i = 0; i < NUM_QUESTIONS_PER_PAGE; i++) {
      questionSentencesList
          .add(questions[pageNum * NUM_QUESTIONS_PER_PAGE + i]);
    }
  }
  ...
  static getNumberPages() {
    return (questions.length / NUM_QUESTIONS_PER_PAGE);
  }
}
