...
import 'package:seab1ird.letitgo/widgets/animated_background/behaviors/ParticleBehaviour.dart';
import 'package:seab1ird.letitgo/widgets/animated_background/behaviors/ParticleOptions.dart';
import 'package:seab1ird.letitgo/widgets/animated_background/behaviors/Particles.dart';
...
class CustomAnimatedBg extends StatefulWidget {
  CustomAnimatedBg({Key key, this.title}) : super(key: key);
...
class _CustomAnimatedBgState extends State<CustomAnimatedBg>
  ...
  Image _image = Image.asset('assets/images/flower.png');
      ...
      case ParticleType.Image:
        return Column(
          children: <Widget>[
            Row(
              children: <Widget>[
                _buildImageSelector(Helpers.getImage('flower')),
                // _buildImageSelector(Image.asset('images/icy_logo.png')),
                RaisedButton(
