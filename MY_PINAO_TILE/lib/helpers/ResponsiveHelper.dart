...
Size getDeviceSize(BuildContext context) => ResponsiveHelper.deviceSize;
bool get isIpad =>
    ResponsiveHelper.deviceSize.width / ResponsiveHelper.deviceSize.height >
    0.65;
double ipadIconSize() => ResponsiveHelper.deviceSize.width / 15;
double ipadFontSize() => ResponsiveHelper.deviceSize.width / 24;
