...
import 'package:seab1ird.vncomedies/widgets/views/TypeListItem.dart';
...
class MovieTypesState extends State<MovieTypes> {
  ...
  void _callAPI() async {
    ...
    final response = await dio.get('https://portaldata-32e82.firebaseapp.com/api/v1/vnComedies');
