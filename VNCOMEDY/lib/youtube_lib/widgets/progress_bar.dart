...
class _ProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final _handleColor = colors?.handleColor ?? Colors.yellowAccent;
