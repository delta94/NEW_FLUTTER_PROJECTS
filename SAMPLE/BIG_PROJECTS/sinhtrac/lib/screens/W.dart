                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          ...
                                          child: Image.asset("images/ws_detail.png", width: 150) 
                                        ),
                                        GestureDetector(
                                          onTap: () {
                                            Navigator.pushNamed(context, '');
                                          },
                                          child: Image.asset("images/wt_detail.png", width: 150) 
                                        )
                                      ],
                                    ),
                                    Divider(),
                                    Row(
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          ...
                                          child: Image.asset("images/we_detail.png", width: 150) 
                                        ),
                                        GestureDetector(
                                          onTap: () {
                                            Navigator.pushNamed(context, '');
                                          },
                                          child: Image.asset("images/wc_detail.png", width: 150) 
                                        )
                                      ],
                                    ),
                                    Divider(),
                                    Row(
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          ...
                                          child: Image.asset("images/wd_detail.png", width: 150) 
                                        ),
                                        GestureDetector(
                                          onTap: () {
                                            Navigator.pushNamed(context, '');
                                          },
                                          child: Image.asset("images/wi_detail.png", width: 150) 
                                        )
                                      ],
                                    ),
                                    Divider(),
                                    Row(
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          ...
                                          child: Image.asset("images/wp_detail.png", width: 150) 
                                        ),
                                        GestureDetector(
                                          onTap: () {
                                            Navigator.pushNamed(context, '');
                                          },
                                          child: Image.asset("images/wx_detail.png", width: 150) 
                                        )
                                      ],
                                    ),
                                    Divider()
