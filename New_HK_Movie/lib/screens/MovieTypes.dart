...
class MovieTypesState extends State<MovieTypes> {
  ...
  void _getData() async {
    ...
    //https://portaldata-32e82.firebaseapp.com/api/v1/FBToken
    final response = await dio.get('https://portaldata-32e82.firebaseapp.com/api/v1/retailHKMoviesFB');
            ...
            child: new GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                if (index == objectList.length ) {
                  return CommonFunctions.buildProgressIndicator(isLoading, message);
                } else {
